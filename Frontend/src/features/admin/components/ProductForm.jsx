...
import { clearSelectedProduct, createProductAsync, fetchProductByIdAsync, selectBrands, selectCategories, selectProductById, updateProductAsync } from '../../product-list/productListSlice';
...
export default function ProductForm() {
    ...
    // console.log(selectedProduct.discountPercentage);
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    ...
                                    {brands.map((brand, index) => (
                                        <option className='bg-gray-700 text-white' key={index} value={brand.value}>{brand.label}</option>
                                    ))}
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    ...
                                    {categories.map((category, index) => (
                                        <option className='bg-gray-700 text-white' key={index} value={category.value}>{category.label}</option>
                                    ))}
                                ...
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                                    <input
                                        ...
                                        {...register('discountPercentage', {
                                            required: 'discount perentage is required',
                                            min: 0,
                                            max: 100
                                        })}
                                        type="number"
