...
import { fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, productSlice, selectAllProducts, selectBrands, selectCategories, selectProductListStatus, selectTotalItems } from "../productListSlice";
      ...
      <div className="bg-white">
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* the pagination part start from here */}
